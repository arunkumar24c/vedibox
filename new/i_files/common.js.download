        ...
        if(typeof img_title != "undefined" && img_title != "") {
            if(jQuery('#image_modal').length > 0) {
                ...
                if(jQuery(obj).parent().find('input[name="sub_images"]').length > 0) {
                    if(jQuery('#image_modal').find('.modal-body').find('.image_video').length > 0) {
                        jQuery('#image_modal').find('.modal-body').find('.image_video').attr('colspan', '4');
                    }
                    jQuery(obj).parent().find('input[name="sub_images"]').each(function(){
                        ...
                        if(typeof sub_image != "undefined" && sub_image != null && sub_image != "") {
                            if(jQuery('#image_modal').find('.modal-body').find('.image_column').length > 0) {
                                jQuery('#image_modal').find('.modal-body').find('.image_column:last').after('<td class="text-center sub_image_row image_column" style="width: 25%; height: 100px; padding: 5px; cursor: pointer;"><img src="'+sub_image+'" class="img-fluid" alt="Crackers" title="Crackers" onClick="Javascript:ShowProductImage(this);"></td>');
                            } 
                        }
                    });
                }
...
function ShowProductVideo(obj) {
    ...
    if(typeof video_id != "undefined" && video_id != "") {
        if(jQuery('#image_modal').find('.modal-body').find('.image_video').length > 0) {
            jQuery('#image_modal').find('.modal-body').find('.image_video').html('<iframe width="100%" height="300" src="https://www.youtube.com/embed/'+video_id+'" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>');
        }
    }
}
...
function CloseImageVideoPopup() {
    ...
    if(jQuery('#image_modal').find('.modal-header').find('button.close').length > 0) {
        jQuery('#image_modal').find('.modal-header').find('button.close').trigger('click');
    }
}
            ...
            if(x.number == '1') {
                ...
                setTimeout(function(){
                    ...
                    if(typeof x.otp_send_date != "undefined" && x.otp_send_date != null && x.otp_send_date != "") {
                        ...
                        if(typeof x.otp_receive_mobile_number != "undefined" && x.otp_receive_mobile_number != null && x.otp_receive_mobile_number != "") {
                            if(jQuery('.otp_receive_mobile_number').length > 0) {
                                jQuery('.otp_receive_mobile_number').html(x.otp_receive_mobile_number);
                            }                            
                            if(typeof x.otp_number != "undefined" && x.otp_number != null && x.otp_number != "") {
                                if(jQuery('.otp_receive_mobile_number').length > 0) {
                        ...
                        if(typeof verify_enquiry_customer_id != "undefined" && verify_enquiry_customer_id != "") {
                            ...
                            window.location = "order_view.php?view_order_id="+x.order_id;
                        }
                    }
                }, 1000);
            }
    ...
    if(jQuery('input[name="promotion_code"]').length > 0) {
        ...
        if(typeof promotion_code != "undefined" && promotion_code != null && promotion_code != "") {
            ...
            if(jQuery('.sub_total').length > 0) {
                ...
                if(typeof sub_total != "undefined" && sub_total != null && sub_total != "") {
